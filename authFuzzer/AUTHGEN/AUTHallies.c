...
//Creates Auth response frame
u_char *Authallies(u_char *dstAddress, int *packetSize, u_char * radioTapHeader, u_char *myMAC, int step)
{

    #define AuthalliesIES  (1)   //number of information elements
