/*
Fuzzes PrbResp by testing many duplicate IEs
*/
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
...
u_char *Prbduplicate(u_char *dstAddress, int *packetSize, u_char * radioTapHeader, u_char *myMAC, int step)
{

    #define PRBduplicateIES  (4)   //number of information elements
    ...
    infoElem taggedParams[PRBduplicateIES] = {
        ssid, suppRates, ds, dups
    };

    //length of all info elements, including id and len field
    int len_taggedParams = 0;
    for(int i = 0; i < PRBduplicateIES; i++)
    {
