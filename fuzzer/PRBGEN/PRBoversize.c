...
u_char *Prboversize(u_char *dstAddress, int *packetSize, u_char * radioTapHeader, u_char *myMAC, int step)
{

    #define PRBoversizeIES  (6)   //number of information elements
    ...
    infoElem taggedParams[PRBoversizeIES] = {
    ...
    for(int i = 0; i < PRBoversizeIES; i++)
    {
